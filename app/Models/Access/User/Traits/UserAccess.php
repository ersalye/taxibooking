...
trait UserAccess
{
    ...
    public function attachTransportation($transportation) {
        if (is_object($transportation)) {
            $transportation = $transportation->getKey();
        }
        ...
        $this->transportations()->attach($transportation);
    }
