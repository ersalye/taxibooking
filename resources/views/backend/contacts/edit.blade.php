...
@section ('title', trans('labels.backend.transportations.management') . ' | ' . trans('labels.backend.transportations.edit'))

@section('page-header')
    <h1>
        {{ trans('labels.backend.transportations.management') }}
        <small>{{ trans('labels.backend.transportations.edit') }}</small>
    </h1>
@endsection

@section('content')

    {{ Form::model($transportation, ['route' => ['admin.transportation.update', $transportation], 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'PATCH']) }}

    <div class="box box-success">
        <div class="box-header with-border">
            <h3 class="box-title">{{ trans('labels.backend.transportations.edit') }}</h3>
        ...
        <div class="box-body">
            ...
            <div class="form-group">
                {{ Form::label('number', trans('labels.backend.transportations.number'), ['class' => 'col-lg-2 control-label']) }}

                <div class="col-lg-10">
                    {{ Form::text('number', null, ['class' => 'form-control', 'placeholder' => trans('validation.attributes.backend.access.users.name')]) }}
                </div><!--col-lg-10-->
            </div><!--form control-->
