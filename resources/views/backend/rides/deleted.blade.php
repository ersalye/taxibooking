...
@section ('title', trans('labels.backend.menus.management') . ' | ' . trans('labels.backend.menus.deleted'))
...
@section('page-header')
    <h1>
        ...
        <small>{{ trans('labels.backend.menus.deleted') }}</small>
    </h1>
@endsection
...
@section('content')
    <div class="box box-success">
        <div class="box-header with-border">
            <h3 class="box-title">{{ trans('labels.backend.menus.deleted') }}</h3>
