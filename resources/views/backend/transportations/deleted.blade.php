...
@section ('title', trans('labels.backend.transportations.management') . ' | ' . trans('labels.backend.transportations.deleted'))
...
@section('page-header')
    <h1>
        ...
        <small>{{ trans('labels.backend.transportations.deleted') }}</small>
    </h1>
@endsection
...
@section('content')
    <div class="box box-success">
        <div class="box-header with-border">
            <h3 class="box-title">{{ trans('labels.backend.transportations.deleted') }}</h3>
